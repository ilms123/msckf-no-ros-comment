...
//已知归一化相机匹配点，相对位姿变换，三角化计算深度，得到相机坐标p（X，Y，Z）
    ...
    const CamStateServer& cam_states) const
{
    ...
    Eigen::Isometry3d first_cam_pose;   //Twc
    ...
    const CamStateServer& cam_states)
{
    ...
    for (auto& m : observations) {
        ...
        // to the world frame.
        Eigen::Isometry3d cam0_pose;   //Twc
